...
class SpatioTempGraphCNN(nn.Module):
    ...
    def __init__(self, graph_args, in_channels=3, num_class=1, 
        ...
        # fcn for prediction
        self.fcn_l = nn.Conv2d(256, num_class, kernel_size=1)
        self.fcn_r = nn.Conv2d(256, num_class, kernel_size=1)
...
class Model(pl.LightningModule):
    def __init__(self, criterion, learning_rate, optimizer, prefix, gpu, in_channels, strategy):
        ...
        self.G_CNN = SpatioTempGraphCNN(graph_args,num_class=14)
