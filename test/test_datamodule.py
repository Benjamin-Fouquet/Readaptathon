...
if __name__ == "__main__":
    ...
    #<------------------ Datashader function to plot skeleton points ------------------->
    ...
    def plot_points(frame=0):
        """
        Plot frame skeleton according to the slider value (frame selection)
        """
    ...
    def plot_acceleration(frame):
        """
        Plot the acceleration of each point over time
        """
        lines=[]
    ...
    #Show app with default parameters
    app.show()
